...
for SEQ_LEN in [2048, 4096, 8192, 16384, 32768, 65536, 131072]:
    ...
    hyena = HyenaOperator(d_model=DIM, l_max=SEQ_LEN, fused_fft_conv=False, groups=3 * DIM,
                          fused_bias_fc=True, modulate=False, emb_dim=33, d_state=64).to(device).to(dtype)
